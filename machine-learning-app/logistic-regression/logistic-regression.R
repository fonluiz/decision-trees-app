...
model.gml = readRDS("logistic-regression/logistic-regression.rds") # modelo com 5 iterações de reamostragens
model.gml2 = readRDS("logistic-regression/logistic-regression2.rds") # modelo com 10 iterações de reamostragens
...
model.lasso = readRDS("logistic-regression/logistic-regression-lasso.rds")
model.ridge = readRDS("logistic-regression/logistic-regression-ridge.rds")
...
cv.lasso = readRDS("logistic-regression/logistic-regression-lasso-cv.rds")
cv.ridge = readRDS("logistic-regression/logistic-regression-ridge-cv.rds")
